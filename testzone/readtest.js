...
ids = ['20230419123456789101000001', '20230419123456789101000002', '20230419123456789101000003', '20230419123456789101000004']
let results = [['唯一編碼', '來源系統', '來源系統縮寫', '文件原系統頁面URL', '題名', '檔案類型',
        ...
        ids.forEach(function(ele, index, ids) {
            ...
            let table = rawTable('../rawfiles/' + userID + '/root/' + format + '/' + hashTable.get(ids[index]));
            ...
            if (table[0][0].substring(0, 4) == '國史館檔') {
                ...
                while (curRow < table.length) {
                    ...
                    results[lines][1] = '國史館檔案史料文物查詢系統-' + results[lines][1];
                ...
                while (curRow < table.length) {
                    ...
                    results[lines][1] = '國史館臺灣文獻館典藏管理系統-' + results[lines][1];
                ...
                while (curRow < table.length) {
                    ...
                    results[lines][1] = '臺灣省議會史料總庫-' + results[lines][1];
                ...
                while (curRow < table.length) {
                    ...
                    results[lines][1] = '地方議會議事錄-' + results[lines][1];
